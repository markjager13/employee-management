...
const TheAvatar = ({name}) => {
    ...
    if (split.length === 1) {
        ...
        let initials = split[0].substring(0, 1).toUpperCase();
        initials += split[split.length - 1].substring(0, 1).toUpperCase();
...
const columns = fetchEmployees => [
    {
        ...
        dataIndex: 'avatar',
        key: 'avatar',
        render: (text, employee) => <TheAvatar name={employee.name}/>
    },
    {
        title: 'Id',
        dataIndex: 'id',
    ...
    const renderEmployees = () => {
        ...
        return <>
            ...
            <Table
                ...
                title={() =>
                    <>
                        <Tag style={{marginLeft: "10px"}}>Number of employees</Tag>
